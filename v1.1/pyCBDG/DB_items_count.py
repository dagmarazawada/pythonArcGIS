...
oracle = [oracleGISPIG2Connector+"\\GIS_PIG2.ZLOZA_GRANICE", oracleGISPIG2Connector+"\\GIS_PIG2.ZLOZA_OBSZARY", oracleGISPIG2Connector+"\\GIS_PIG2.ZLOZA_TERENY", oracleGISPIG2Connector+"\\GIS_PIG2.OTWORY", oracleGISPIG2Connector+"\\GIS_PIG2.JASKINIE"]
oracleSDO = [oracle_gis_sdo+"\\GIS_SDO.ZLOZA_GRANICE", oracle_gis_sdo+"\\GIS_SDO.ZLOZA_OBSZARY", oracle_gis_sdo+"\\GIS_SDO.ZLOZA_TERENY", oracle_hydro_sdo+"\\HYDRO_SDO.HYDRO_MWP", oracle_hydro_sdo+"\\HYDRO_SDO.HYDRO_OTWORY"]

zrodlo = [layers[5], layers[3], layers[4], oracleConnector+"\\OTWORYPROD.OTWORY", oracleConnector+"\\JASKINIEPOLSKI.V_JASKINIE", oracle_hydro_sdo+"\\HYDRO_SDO.HYDRO_MV_MWP", oracle_hydro_sdo+"\\HYDRO_SDO.HYDRO_MV_OTWORY"]
...
print "\nSprawdzenie liczby obiektow w warstwach ORACLE (sdo): "
k = 0
for n in oracleSDO:
    print n[32:] + " : " + str(arcpy.GetCount_management(n))
    k=k+1
