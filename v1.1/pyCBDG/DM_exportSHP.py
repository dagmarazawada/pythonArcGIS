...
def send_mail_info(lyrNr):
    ...
    to = 'dzaw@pgi.gov.pl; wpac@pgi.gov.pl'
...
# funkcja list(set())) usuwa powtorzenia - SPRAWDZIC
...
print list(set(DMlayers))
print len(list(set(DMlayers)))
...
for n in files_to_rm:
    ...
    remove_old_files("G:\\" + n + weekends_ + ".zip")
